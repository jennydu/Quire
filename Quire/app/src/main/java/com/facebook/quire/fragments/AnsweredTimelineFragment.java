 ...
 */
public class AnsweredTimelineFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        populateAnsweredQuires();
    }

    public static AnsweredTimelineFragment newInstance(String uid) {
        AnsweredTimelineFragment answeredTimelineFragment = new AnsweredTimelineFragment();
        Bundle args = new Bundle();
        args.putString("uid",uid);
        answeredTimelineFragment.setArguments(args);
        return answeredTimelineFragment;
    }

    public void populateAnsweredQuires() {
        mDatabase.child("users").child(mUserId).child("answeredQuires").orderByChild("invertedTimestamp").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
